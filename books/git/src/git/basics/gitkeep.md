...
* Not a real feature but a convention is to add an empty file called `.gitkeep` to the directory you'd like to keep and add that file to git. This will make git track the directory.
