...
my @pairs = (
    ...
    ["szabgab", "github-actions-perl-using-perl-tester-docker-image", "perl_makefile_tester.yml", "perl-perldocker-perl-tester.yml"],
    ["szabgab", "github-actions-perl-dist-zilla", "native.yml", "perl-dist-zilla-native.yml"],
    ["szabgab", "github-actions-perl-dist-zilla", "docker.yml", "perl-dist-zilla-docker.yml"],
    ["szabgab", "github-actions-perl-with-test-coverage", "ci.yml", "perl-test-coverage.yml"],
    ["szabgab", "github-actions-perl-makefile-release-and-test", "ci.yml", "perl-makefile-release-and-test.yml"],
    ...
    ["szabgab", "github-actions-matrix-environment-variables", "ci.yml", "matrix_env_vars.yml"],
